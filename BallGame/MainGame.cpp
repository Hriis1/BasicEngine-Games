...
void MainGame::init() {
    ...
    m_screenWidth = 2300 * (1.0f/1.5f);
    m_screenHeight = 1300 * (1.0f / 1.5f);
    ...
    m_spriteFont = std::make_unique<BasicEngine::SpriteFont>("Fonts/chintzy.ttf", 40);
...
struct BallSpawn {
    BallSpawn(const BasicEngine::Color& colr,
...
#define ADD_BALL(p, ...) \
    ...
    ADD_BALL(1.0f, BasicEngine::Color(255, 255, 255, 255),
             2.0f, 1.0f, 0.1f, 7.0f, totalProbability);
    ADD_BALL(1.0f, BasicEngine::Color(1, 254, 145, 255),
             2.0f, 2.0f, 0.1f, 3.0f, totalProbability);
    ADD_BALL(1.0f, BasicEngine::Color(177, 0, 254, 255),
             3.0f, 4.0f, 0.0f, 0.0f, totalProbability)
    ADD_BALL(1.0f, BasicEngine::Color(254, 0, 0, 255),
             3.0f, 4.0f, 0.0f, 0.0f, totalProbability);
    ADD_BALL(1.0f, BasicEngine::Color(0, 255, 255, 255),
             3.0f, 4.0f, 0.0f, 0.0f, totalProbability);
    ADD_BALL(1.0f, BasicEngine::Color(255, 255, 0, 255),
             3.0f, 4.0f, 0.0f, 0.0f, totalProbability);
    // Make a bunch of random ball types
    for (int i = 0; i < 10000; i++) {
        ADD_BALL(1.0f, BasicEngine::Color(r2(randomEngine), r2(randomEngine), r2(randomEngine), 255),
    ...
    for (int i = 0; i < NUM_BALLS; i++) {
        ...
        m_balls.emplace_back(ballToSpawn->radius, ballToSpawn->mass, pos, direction * ballToSpawn->randSpeed(randomEngine),
                             BasicEngine::ResourceManager::getTexture("Textures/circle.png").id,
                             ballToSpawn->color);
...
void MainGame::drawHud() {
    const BasicEngine::Color fontColor(255, 0, 0, 255);
